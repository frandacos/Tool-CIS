...
# PSRemoting), asi que Test-CIS_WS2025_19_* audita el HKCU de ESA sesion, no de
...
function Test-CIS_WS2025_19_5_1_1 {
...
function Set-CIS_WS2025_19_5_1_1 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\PushNotifications' -Name 'NoToastApplicationNotificationOnLockScreen' -Type DWord -Value 1 }

function Test-CIS_WS2025_19_6_6_1_1 {
...
function Set-CIS_WS2025_19_6_6_1_1 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Assistance\Client\1.0' -Name 'NoImplicitFeedback' -Type DWord -Value 1 }

# Clasico "Mark of the Web" de adjuntos (distinto del control nuevo 18.10.29.2).
function Test-CIS_WS2025_19_7_5_1 {
...
function Set-CIS_WS2025_19_7_5_1 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Attachments' -Name 'SaveZoneInformation' -Type DWord -Value 2 }

function Test-CIS_WS2025_19_7_5_2 {
...
function Set-CIS_WS2025_19_7_5_2 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\Attachments' -Name 'ScanWithAntiVirus' -Type DWord -Value 3 }

function Test-CIS_WS2025_19_7_8_1 {
...
function Set-CIS_WS2025_19_7_8_1 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'ConfigureWindowsSpotlight' -Type DWord -Value 2 }

function Test-CIS_WS2025_19_7_8_2 {
...
function Set-CIS_WS2025_19_7_8_2 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'DisableThirdPartySuggestions' -Type DWord -Value 1 }

function Test-CIS_WS2025_19_7_8_3 {
...
function Set-CIS_WS2025_19_7_8_3 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'DisableTailoredExperiencesWithDiagnosticData' -Type DWord -Value 1 }

function Test-CIS_WS2025_19_7_8_4 {
...
function Set-CIS_WS2025_19_7_8_4 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'DisableWindowsSpotlightFeatures' -Type DWord -Value 1 }

function Test-CIS_WS2025_19_7_8_5 {
...
function Set-CIS_WS2025_19_7_8_5 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'DisableSpotlightCollectionOnDesktop' -Type DWord -Value 1 }

function Test-CIS_WS2025_19_7_26_1 {
...
function Set-CIS_WS2025_19_7_26_1 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer' -Name 'NoInplaceSharing' -Type DWord -Value 1 }

function Test-CIS_WS2025_19_7_46_2_1 {
...
function Set-CIS_WS2025_19_7_46_2_1 { Set-CISRegistryValue -Path 'HKCU:\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer' -Name 'PreventCodecDownload' -Type DWord -Value 1 }
