...
function Test-CIS_WS2025_1_1_1 {
    [CmdletBinding()]
    param()
...
function Test-CIS_WS2025_1_1_2 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
...
function Test-CIS_WS2025_1_1_3 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
...
function Test-CIS_WS2025_1_1_4 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
...
function Test-CIS_WS2025_1_1_5 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
...
function Test-CIS_WS2025_1_1_6 {
    [CmdletBinding()]
    param()
...
function Test-CIS_WS2025_1_1_7 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
...
function Test-CIS_WS2025_1_2_1 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
...
function Test-CIS_WS2025_1_2_2 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
...
function Test-CIS_WS2025_1_2_3 {
    [CmdletBinding()]
    param()
    if ((Get-CISServerRole) -eq 'DC') {
...
function Set-CIS_WS2025_1_2_3 {
    [CmdletBinding()]
    param()
    Write-Warning '1.2.3 es (Manual): este benchmark no define un mecanismo de remediacion automatizable via registro/secedit. Aplicar manualmente el UI Path indicado en Test-CIS_WS2025_1_2_3 via GPO.'
}

# --- 1.2.4 Reset account lockout counter after: 15 or more minute(s) -----

function Test-CIS_WS2025_1_2_4 {
    [CmdletBinding()]
    param()
    $policy = Get-CISSecurityPolicy
