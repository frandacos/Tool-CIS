...
Export-ModuleMember -Function @(
    ...
    'Get-CISSysctlValue',
    'Set-CISSysctlValue',
    'Get-CISSysctlConfigFiles',
    'Get-CISSysctlPersistedValue',
    'Test-CISSysctlSetting',
    'Set-CISSysctlEnforced',
    'Test-CISPathAccess',
    'Get-CISSystemdConfigValue',
    'Set-CISSystemdConfigValue',
    'Get-CISDconfKeyFiles',
    'Get-CISDconfValue',
    'Test-CISDconfPathLocked',
    'Set-CISDconfKeyFile',
    'Set-CISDconfLock',
    'Get-CISSshdPath',
    'ConvertFrom-CISSshdOutput',
    'Get-CISSshdConfig',
    'Get-CISSshdVersion',
    'Set-CISSshdOption',
