...
function Set-CIS_9_1_1 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Domain -Name 'EnableFirewall' -Type DWord -Value 1 }

function Test-CIS_9_1_2 {
...
function Set-CIS_9_1_2 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Domain -Name 'DefaultInboundAction' -Type DWord -Value 1 }

function Test-CIS_9_1_3 {
...
function Set-CIS_9_1_3 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Domain -Name 'DisableNotifications' -Type DWord -Value 1 }

function Test-CIS_9_1_4 {
...
function Set-CIS_9_1_4 { param([string]$Path = '%SystemRoot%\System32\logfiles\firewall\domainfw.log') Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Domain) -Name 'LogFilePath' -Type String -Value $Path }

function Test-CIS_9_1_5 {
...
function Set-CIS_9_1_5 { param([int]$Value = 16384) Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Domain) -Name 'LogFileSize' -Type DWord -Value $Value }

function Test-CIS_9_1_6 {
...
function Set-CIS_9_1_6 { Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Domain) -Name 'LogDroppedPackets' -Type DWord -Value 1 }

function Test-CIS_9_1_7 {
...
function Set-CIS_9_1_7 { Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Domain) -Name 'LogSuccessfulConnections' -Type DWord -Value 1 }
...
function Set-CIS_9_2_1 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Private -Name 'EnableFirewall' -Type DWord -Value 1 }
...
function Set-CIS_9_2_2 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Private -Name 'DefaultInboundAction' -Type DWord -Value 1 }
...
function Set-CIS_9_2_3 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Private -Name 'DisableNotifications' -Type DWord -Value 1 }
...
function Set-CIS_9_2_4 { param([string]$Path = '%SystemRoot%\System32\logfiles\firewall\privatefw.log') Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Private) -Name 'LogFilePath' -Type String -Value $Path }
...
function Set-CIS_9_2_5 { param([int]$Value = 16384) Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Private) -Name 'LogFileSize' -Type DWord -Value $Value }
...
function Set-CIS_9_2_6 { Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Private) -Name 'LogDroppedPackets' -Type DWord -Value 1 }
...
function Set-CIS_9_2_7 { Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Private) -Name 'LogSuccessfulConnections' -Type DWord -Value 1 }
...
function Set-CIS_9_3_1 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Public -Name 'EnableFirewall' -Type DWord -Value 1 }
...
function Set-CIS_9_3_2 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Public -Name 'DefaultInboundAction' -Type DWord -Value 1 }
...
function Set-CIS_9_3_3 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Public -Name 'DisableNotifications' -Type DWord -Value 1 }
...
function Set-CIS_9_3_4 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Public -Name 'AllowLocalPolicyMerge' -Type DWord -Value 0 }
...
function Set-CIS_9_3_5 { Set-CISRegistryValue -Path $script:CISFirewallProfilePaths.Public -Name 'AllowLocalIPsecPolicyMerge' -Type DWord -Value 0 }
...
function Set-CIS_9_3_6 { param([string]$Path = '%SystemRoot%\System32\logfiles\firewall\publicfw.log') Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Public) -Name 'LogFilePath' -Type String -Value $Path }
...
function Set-CIS_9_3_7 { param([int]$Value = 16384) Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Public) -Name 'LogFileSize' -Type DWord -Value $Value }
...
function Set-CIS_9_3_8 { Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Public) -Name 'LogDroppedPackets' -Type DWord -Value 1 }
...
function Set-CIS_9_3_9 { Set-CISRegistryValue -Path (Get-CISFirewallLoggingPath Public) -Name 'LogSuccessfulConnections' -Type DWord -Value 1 }
