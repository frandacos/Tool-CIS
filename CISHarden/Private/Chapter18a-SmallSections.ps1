...
function Set-CIS_18_1_1_1 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Personalization' -Name 'NoLockScreenCamera' -Type DWord -Value 1 }
...
function Set-CIS_18_1_1_2 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Personalization' -Name 'NoLockScreenSlideshow' -Type DWord -Value 1 }
...
function Set-CIS_18_1_2_2 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\InputPersonalization' -Name 'AllowInputPersonalization' -Type DWord -Value 0 }

function Test-CIS_18_1_3 {
...
function Set-CIS_18_1_3 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'AllowOnlineTips' -Type DWord -Value 0 }
...
function Set-CIS_18_4_1 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System' -Name 'LocalAccountTokenFilterPolicy' -Type DWord -Value 0 -Scope MS }
...
function Set-CIS_18_4_2 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\mrxsmb10' -Name 'Start' -Type DWord -Value 4 }
...
function Set-CIS_18_4_3 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters' -Name 'SMB1' -Type DWord -Value 0 }
...
function Set-CIS_18_4_4 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Microsoft\Cryptography\Wintrust\Config' -Name 'EnableCertPaddingCheck' -Type DWord -Value 1 }
...
function Set-CIS_18_4_5 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Windows' -Name 'DisableExceptionChainValidation' -Type DWord -Value 0 }
...
function Set-CIS_18_4_6 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\NetBT\Parameters' -Name 'NodeType' -Type DWord -Value 2 }
...
function Set-CIS_18_5_1 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon' -Name 'AutoAdminLogon' -Type String -Value '0' }
...
function Set-CIS_18_5_2 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters' -Name 'DisableIPSourceRouting' -Type DWord -Value 2 }
...
function Set-CIS_18_5_3 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters' -Name 'DisableIPSourceRouting' -Type DWord -Value 2 }

function Test-CIS_18_5_4 {
...
function Set-CIS_18_5_4 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters' -Name 'EnableICMPRedirect' -Type DWord -Value 0 }
...
function Set-CIS_18_5_5 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters' -Name 'KeepAliveTime' -Type DWord -Value 300000 }

function Test-CIS_18_5_6 {
...
function Set-CIS_18_5_6 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Netbt\Parameters' -Name 'NoNameReleaseOnDemand' -Type DWord -Value 1 }
...
function Set-CIS_18_5_7 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters' -Name 'PerformRouterDiscovery' -Type DWord -Value 0 }

function Test-CIS_18_5_8 {
...
function Set-CIS_18_5_8 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager' -Name 'SafeDllSearchMode' -Type DWord -Value 1 }
...
function Set-CIS_18_5_9 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters' -Name 'TcpMaxDataRetransmissions' -Type DWord -Value 3 }
...
function Set-CIS_18_5_10 { Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters' -Name 'TcpMaxDataRetransmissions' -Type DWord -Value 3 }

function Test-CIS_18_5_11 {
...
function Set-CIS_18_5_11 { param([int]$Value = 90) Set-CISRegistryValue -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\Eventlog\Security' -Name 'WarningLevel' -Type DWord -Value $Value }

# ===================== 18.8 Start Menu and Taskbar =====================

function Test-CIS_18_8_1_1 {
...
function Set-CIS_18_8_1_1 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\PushNotifications' -Name 'NoCloudApplicationNotification' -Type DWord -Value 1 }

# ===================== 18.11 Custom Settings =====================

function Test-CIS_18_11_1 {
...
function Set-CIS_18_11_1 { Set-CISRegistryValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WinHttpAutoProxySvc' -Name 'DisableWpad' -Type DWord -Value 1 }
...
function Set-CIS_18_11_2 { Write-Warning '18.11.2: sin remediacion automatizada, ver Test-CIS_18_11_2.' }
